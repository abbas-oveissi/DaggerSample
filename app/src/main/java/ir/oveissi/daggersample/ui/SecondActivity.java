...
import ir.oveissi.daggersample.di.DaggerActivityComponent;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        DaggerActivityComponent dac= (DaggerActivityComponent) DaggerActivityComponent.builder()
                .applicationComponent(DaggerSampleApplication.getComponent())
                .build();
        dac.inject(this);
    ...
    private void initRecyclerview() {
        ...
        mListAdapter=new MovieAdapter(SecondActivity.this, new ArrayList<Movie>());
